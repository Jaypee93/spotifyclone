	...
	return (
		<Box id="Playlist__page" sx={{ backgroundColor: 'background.paper', flex: 1, overflowY: 'auto' }}>
			<Box
				...
				sx={{
					width: '100%',
					background: 'linear-gradient(0deg, #121212 0%, #1bd760 100%);',
					display: 'flex',
			...
			>
				{status.isLoading ? (
					<Skeleton
						variant="square"
						sx={{ width: { xs: '100%', md: 234 }, height: { xs: '100%', md: 234 } }}
					/>
				) : (
					<Avatar
						...
						sx={{ boxShadow: 15, width: { xs: '100%', md: 234 }, height: { xs: '100%', md: 234 } }}
					/>
				)}
				<Box>
